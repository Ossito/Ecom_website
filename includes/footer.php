        ...
        <div class="row">
            <div class="col-sm-6 col-md-3">
                ...
                <ul>
                    ...
                    <li><a href="customer/my_account.php"><i class="fa fa-user"></i> Mon Compte</a></li>
                ...
                <ul>
                    <?php
                        if(!isset($_SESSION['email_cli'])){
                            ...
                            echo "<a href='customer/my_account.php?my_orders'><i class='fa fa-user'></i> Mon Compte</a>";
                        }
                    ?>
                    <li><a href="customer_register.php"><i class="fa fa-user-plus"></i> S'inscrire</a></li>
                </ul>
